  ...
  return (
    <div className="fixed bottom-3 right-3 z-50">
      ...
      >
        ...
        <span className="absolute -top-1 -right-1 bg-white text-[#25D366] text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
